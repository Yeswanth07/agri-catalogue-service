...
public class Constants{
    ...
    public static final String PREVIEW = "PREVIEW"; // record created only to preview the generated id, not part of the lifecycle
    ...
    public static final String INVALID_DECISION = "Invalid decision, expected 'confirm' or 'discard'";
